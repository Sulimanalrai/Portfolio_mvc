                    ...
                    <div class="col-4">
                        <div class="card">
                          ...
                          <p class="card-text"> <br>
                              <a href="calculator.html "class="btn btn-dark">Ga naar GITHUB account</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                              <h5 class="card-title">BKE </h5>
                              <p class="card-text"> <br>
                              <a href="index1.html" class="btn btn-dark">Ga naar GITHUB account</a>
                            </div>
                        </div>
                    </div>
                </div>
